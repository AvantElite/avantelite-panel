  ...
  return (
    <aside className="flex h-screen w-64 shrink-0 flex-col sidebar-glass">
      <div className="flex h-16 items-center gap-2 border-b px-6">
        ...
        <span className="text-lg font-semibold text-foreground">Avantservice</span>
      </div>
      ...
      <div className="border-t border-white/5 p-3">
        <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-red-500/10 hover:text-red-400">
